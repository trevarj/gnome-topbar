//! Shared CSS class constants for gnome-topbar.
//!
...
pub mod widget {
    ...
    /// Workspace progress canvas (`.workspace-indicator-progress`).
    pub const WORKSPACE_INDICATOR_PROGRESS: &str = "workspace-indicator-progress";
...
/// Tooltip classes.
pub mod tooltip {
    /// Tooltip window (`.gnome-topbar-tooltip`).
    pub const WINDOW: &str = "gnome-topbar-tooltip";

    /// Tooltip label (`.gnome-topbar-tooltip-label`).
