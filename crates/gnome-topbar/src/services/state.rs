//! State persistence service for gnome-topbar
//!
//! Persists runtime state to $XDG_STATE_HOME/gnome-topbar/state.json
//! This includes:
...
pub struct MediaState {
    /// Whether the media window was open when gnome-topbar last closed
...
///
/// Location: `$XDG_STATE_HOME/gnome-topbar/state.json`
/// Default: `~/.local/state/gnome-topbar/state.json`
