//! TooltipManager - process-wide tooltip handling for the gnome-topbar bar.
//!
...
use gnome_topbar_core::SurfaceStyles;
...
impl TooltipManager {
    ...
    /// e.g., when closing a popover or switching between transient surfaces.
