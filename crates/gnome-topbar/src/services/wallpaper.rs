...
//! use by the theming system in `gnome-topbar-core`.
//!
...
use gnome_topbar_core::{expand_tilde, theme::relative_luminance};
...
mod tests {
    ...
    fn test_extract_theme_grayscale_preserves_luminance() {
        ...
        let path = std::env::temp_dir().join("gnome-topbar_test_grayscale.png");
...
7f0000000000-7f0000010000 r-xp 00000000 fd:00 1 /usr/lib/libhyprtoolkit-plugin.so.1\n";
    ...
    fn test_detect_hyprpaper_hyprwire_happy_path() {
        ...
        let socket_path = std::env::temp_dir().join(format!(
            "gnome-topbar_test_hyprwire_happy_{}.sock",
            std::process::id()
        ));
