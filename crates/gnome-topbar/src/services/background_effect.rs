...
const BLUR_REGION_RESIZE_WATCHED_KEY: &str = "gnome-topbar-blur-resize-watched";
const BLUR_SURFACE_RESIZE_WATCHED_KEY: &str = "gnome-topbar-blur-surface-watched";
...
/// Manages `ext-background-effect-v1` blur region hints for all gnome-topbar surfaces.
...
impl BackgroundEffectManager {
    ...
    pub fn apply_blur_region(&self, window: &gtk4::ApplicationWindow, shadow_margin: i32) {
        ...
        if width <= 0 || height <= 0 {
            ...
            const RETRY_KEY: &str = "gnome-topbar-blur-region-retry-pending";
