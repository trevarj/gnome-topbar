...
use gtk4::prelude::*;
use gtk4::{
    Align, Box as GtkBox, Button, Label, ListBox, ListBoxRow, Orientation, Overlay, Revealer, Scale,
};
...
///
/// External mic volume can exceed GNOME Topbar's configured cap, but this is an
