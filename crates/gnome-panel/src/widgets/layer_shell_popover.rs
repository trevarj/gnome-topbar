    ...
    F: Fn() + Clone + 'static,
{
    let catcher = ApplicationWindow::builder()
        .application(app)
        .title("gnome-panel click catcher")
        .decorated(false)
        .build();
    ...
    catcher.set_namespace(Some("gnome-panel-click-catcher"));
...
impl LayerShellPopover {
    ...
    fn ensure_window_shell(self: &Rc<Self>) -> ApplicationWindow {
        ...
        let window = ApplicationWindow::builder()
            ...
            .title(format!("gnome-panel {} popover", self.widget_name))
            .decorated(false)
            .resizable(false)
            .build();
        ...
        window.set_namespace(Some(&format!("gnome-panel-{}-popover", self.widget_name)));
