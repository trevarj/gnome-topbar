...
//! `/tmp/gnome-panel-debug-mobile` with a state string. The panel polls the file
...
//! echo "connected" > /tmp/gnome-panel-debug-mobile    # simulate connected modem
//! echo "disabled"  > /tmp/gnome-panel-debug-mobile     # simulate disabled modem
//! rm /tmp/gnome-panel-debug-mobile                     # back to normal
//! ```
...
/// 2. The debug mock file (`/tmp/gnome-panel-debug-mobile`) exists.
///
