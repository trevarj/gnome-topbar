//! State persistence service for gnome-panel
//!
//! Persists runtime state to $XDG_STATE_HOME/gnome-panel/state.json
//! This includes:
...
pub struct MediaState {
    /// Whether the media window was open when gnome-panel last closed
...
///
/// Location: `$XDG_STATE_HOME/gnome-panel/state.json`
/// Default: `~/.local/state/gnome-panel/state.json`
