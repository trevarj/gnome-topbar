...
//! use by the theming system in `gnome-panel-core`.
//!
...
use gnome_panel_core::{expand_tilde, theme::relative_luminance};
...
mod tests {
    ...
    fn test_extract_theme_grayscale_preserves_luminance() {
        ...
        let path = std::env::temp_dir().join("gnome-panel_test_grayscale.png");
...
7f0000000000-7f0000010000 r-xp 00000000 fd:00 1 /usr/lib/libhyprtoolkit-plugin.so.1\n";
    ...
    fn test_detect_hyprpaper_hyprwire_happy_path() {
        ...
        let socket_path = std::env::temp_dir().join(format!(
            "gnome-panel_test_hyprwire_happy_{}.sock",
            std::process::id()
        ));
