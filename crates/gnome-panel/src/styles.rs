//! Shared CSS class constants for gnome-panel.
//!
...
/// Tooltip classes.
pub mod tooltip {
    /// Tooltip window (`.gnome-panel-tooltip`).
    pub const WINDOW: &str = "gnome-panel-tooltip";

    /// Tooltip label (`.gnome-panel-tooltip-label`).
    pub const LABEL: &str = "gnome-panel-tooltip-label";
}
